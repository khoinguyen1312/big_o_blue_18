...
public class Promotion2 {
	...
	public static int calculateCostOfPromotion(List<List<Integer>> days) {
		/*
		 * Should use an id for storing and calcualte if this ticket has been checked         
		 * use an array to store if this ticket has been checked or not -> reduce complexity  
		 * Ex: Array[Ticket]
		 * Ticket {
		 * 	 value,
		 * 	 id,
